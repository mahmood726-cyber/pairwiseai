        # Pairwiseai: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/pairwiseai.git

        ## Objective

        PairwiseAI is an AI-assisted pairwise meta-analysis platform that combines automated data extraction with validated pooling algorithms and publication-bias detection.
        ...
        - Code: https://github.com/mahmood726-cyber/pairwiseai.git
