...
// reference material on 2026-04-07 and is not loaded by any page. The top
// `(function() {` IIFE is missing the inner `function showToast(...)` header
// — the body uses undeclared `toast`/`type`/`message`. The complete source
// isn't recoverable, so suppressing parse-check until the file is restored
// or removed.
(function() {
